...
var validate = (function() {
  ...
  var refVal1 = (function() {
    ...
    refVal[1] = refVal1;
    return function validate(data, dataPath, parentData, parentDataProperty, rootData) {
      'use strict'; /*# sourceURL=https://schema.croct.io/sdk/web/cart.json */
      var vErrors = null;
      var errors = 0;
      if (rootData === undefined) rootData = data;
      if ((data && typeof data === "object" && !Array.isArray(data))) {
                            ...
                            if (valid1) {
                              ...
                              if (data1 === undefined) {
                                ...
                                validate.errors = [{
                                  ...
                                  message: 'should have required property \'lastUpdateTime\''
                                }];
                                return false;
                              } else {
                                var errs_1 = errors;
                                if ((typeof data1 !== "number" || (data1 % 1) || data1 !== data1)) {
                                  validate.errors = [{
                                    keyword: 'type',
                                    dataPath: (dataPath || '') + '/lastUpdateTime',
                                    schemaPath: '#/properties/lastUpdateTime/type',
                                    params: {
                                      type: 'integer'
                                    },
                                    message: 'should be integer'
  ...
  refVal1.schema = {
    "$schema": "http://json-schema.org/schema#",
    "$id": "https://schema.croct.io/sdk/web/cart.json",
    "type": "object",
    "properties": {
      "cartId": {
        "type": "string",
      ...
      "items": {
        "type": "array",
        "items": {
          "$ref": "https://schema.croct.io/sdk/web/cart-item.json"
        },
        "minItems": 1
      },
      "subtotal": {
  ...
  refVal[1] = refVal1;
  return function validate(data, dataPath, parentData, parentDataProperty, rootData) {
    'use strict'; /*# sourceURL=https://schema.croct.io/sdk/web/checkout-started.json */
    var vErrors = null;
    var errors = 0;
    if (rootData === undefined) rootData = data;
    if ((data && typeof data === "object" && !Array.isArray(data))) {
      if (true) {
        ...
        if (data.cart === undefined) {
          ...
          validate.errors = [{
            ...
            schemaPath: '#/required',
            params: {
              missingProperty: 'cart'
            },
            message: 'should have required property \'cart\''
          }];
          return false;
        } else {
          var errs_1 = errors;
          if (!refVal1(data.cart, (dataPath || '') + '/cart', data, 'cart', rootData)) {
            if (vErrors === null) vErrors = refVal1.errors;
            else vErrors = vErrors.concat(refVal1.errors);
            errors = vErrors.length;
          }
...
validate.schema = {
  "$schema": "http://json-schema.org/schema#",
  "$id": "https://schema.croct.io/sdk/web/checkout-started.json",
  "type": "object",
  "properties": {
    "cart": {
      "$ref": "https://schema.croct.io/sdk/web/cart.json"
    },
    "orderId": {
      "type": "string",
      "minLength": 1,
