...
var validate = (function() {
  ...
  var refVal1 = (function() {
    ...
    refVal[1] = refVal1;
    return function validate(data, dataPath, parentData, parentDataProperty, rootData) {
      'use strict'; /*# sourceURL=https://schema.croct.io/web/cart.json */
      var vErrors = null;
      var errors = 0;
      if (rootData === undefined) rootData = data;
      if ((data && typeof data === "object" && !Array.isArray(data))) {
  ...
  refVal1.schema = {
    "$schema": "http://json-schema.org/schema#",
    "$id": "https://schema.croct.io/web/cart.json",
    "type": "object",
    "properties": {
      "cartId": {
        "type": "string"
      ...
      "items": {
        "type": "array",
        "items": {
          "$ref": "https://schema.croct.io/web/cart-item.json"
        }
      },
      "subtotal": {
        "type": "number"
  ...
  refVal[1] = refVal1;
  return function validate(data, dataPath, parentData, parentDataProperty, rootData) {
    'use strict'; /*# sourceURL=https://schema.croct.io/web/checkout-started.json */
    var vErrors = null;
    var errors = 0;
    if (rootData === undefined) rootData = data;
    if ((data && typeof data === "object" && !Array.isArray(data))) {
...
validate.schema = {
  "$schema": "http://json-schema.org/schema#",
  "$id": "https://schema.croct.io/web/checkout-started.json",
  "type": "object",
  "properties": {
    "cart": {
      "$ref": "https://schema.croct.io/web/cart.json"
    },
    "orderId": {
      "type": "string"
    }
