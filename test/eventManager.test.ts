...
describe('A synchronous event manager', () => {
    it('should dispatch events to subscribed listeners', () => {
    ...
    it('should not fail if no listener is subscribed to a given event', () => {
        const eventManager = new SynchronousEventManager<TestEventMap>();
    ...
    it('should ignore attempts to unsubscribe an non-existing listener', () => {
        const eventManager = new SynchronousEventManager<TestEventMap>();
