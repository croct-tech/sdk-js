...
describe('A cache token store', () => {
    ...
    it('should store tokens into cache', () => {
    ...
    it('should remove a token set to null from the cache', () => {
        const store = new CachedTokenStore(new InMemoryCache());
    ...
    it('should retrieve the token from the cache', () => {
        const store = new CachedTokenStore(new InMemoryCache());
    ...
    it('should consider corrupted tokens as null', () => {
